...
class test_add_contact_2(unittest.TestCase):
    ...
    def test_add_contact_2(self):
        ...
        self.fill_the_form(wd, Contacts(firstname="Oksana", middlename="Oksana", lastname="Prokopek", nickname="ProOksana", title="Test_title", company="Test_Company",
                           address="Wrocław, ul. Damrota 48/5", mobile="500300488", home="500300488", work="500300488",
                           email="prokopekoksana@gmail.com"))
        self.submit_add_new(wd)
        self.logout(wd)

    def test_add_empty_contact_2(self):
        wd = self.wd
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.open_add_new()
        wd.find_element_by_link_text("add new").click()
        self.fill_the_form(wd, Contacts(firstname="", middlename="", lastname="", nickname="",
                            title="", company="",
                            address="", mobile="", home="",
                            work="",
                            email=""))
